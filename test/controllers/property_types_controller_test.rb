...
class PropertyTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create property_type" do
    assert_difference('PropertyType.count') do
      post property_types_url, params: { property_type: { created_at: @property_type.created_at, edited_at: @property_type.edited_at, name: @property_type.name, updated_at: @property_type.updated_at } }, as: :json
    end
  ...
  test "should update property_type" do
    patch property_type_url(@property_type), params: { property_type: { created_at: @property_type.created_at, edited_at: @property_type.edited_at, name: @property_type.name, updated_at: @property_type.updated_at } }, as: :json
    assert_response 200
  end
